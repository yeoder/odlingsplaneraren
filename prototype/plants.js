// Växtdatabas för odlingsplaneraren.
// Alla tider anges relativt "sista vårfrost" (veckor), avstånd i cm, temp i °C.
// avstand_cm = rekommenderat avstånd mellan plantor (plantans "fotavtryck" i diameter).
const PLANTS = [
  {
