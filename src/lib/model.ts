...
export interface Garden {
  ...
  forstaHostfrostDatum: string; // ISO-datum, sätter säsongens slut
...
export function newGarden(): Garden {
  return {
    ...
    showLabels: false, plantHeights: {}, uppsatt: false,
    sistaFrostDatum: "2026-05-15", forstaHostfrostDatum: "2026-10-10",
